...
IF(NOT EXISTS "/home/pth/pth/model/Go2_simulator/build/pinocchio/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/home/pth/pth/model/Go2_simulator/build/pinocchio/install_manifest.txt")

MESSAGE(STATUS "catkin path: /home/pth/pth/model/Go2_simulator/devel/.catkin")
IF(EXISTS "/home/pth/pth/model/Go2_simulator/devel/.catkin" AND PACKAGE_CREATES_DOT_CATKIN)
  MESSAGE(STATUS "Try to remove /home/pth/pth/model/Go2_simulator/devel/.catkin")
  EXECUTE_PROCESS(
      COMMAND ${CMAKE_COMMAND} -E remove "/home/pth/pth/model/Go2_simulator/devel/.catkin"
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/home/pth/pth/model/Go2_simulator/build/pinocchio/install_manifest.txt" files)
STRING(REPLACE "\n" ";" files "${files}")
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND ${CMAKE_COMMAND} -E remove "/home/pth/pth/model/Go2_simulator/build/pinocchio/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
